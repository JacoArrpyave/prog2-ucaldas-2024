    ...
    public void option_menu() {
        ...
        switch (option) {
            case 1:
                ...
                if (option_submenu == 1) {
                    Running manRunningShoes = new Running();   
                    manRunningShoes.addRunningShoes();
                    System.out.println(manRunningShoes.showInformationShoes(manRunningShoes.running_shoes));
                    ...
                    System.out.println(instance_classic.showInformationShoes(instance_classic.getShoesWithSeveralColors(5)));
                } else {
